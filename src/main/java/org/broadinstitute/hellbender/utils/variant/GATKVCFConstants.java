...
public final class GATKVCFConstants {
    ...
    public static final String GENOTYPE_QUALITY_BY_ALLELE_BALANCE = "ABGQ"; //MakeVQSRinput
    public static final String GENOTYPE_QUALITY_BY_ALT_CONFIDENCE = "ALTGQ"; //MakeVQSRinput
